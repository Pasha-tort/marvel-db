...
import FiltersCharacters from './filters';
import ItemCharactersList from './itemCharactersList';
import Spinner from '../../spinner/spinner';

// const ItemsListThreeColumns = styled.ul `
//     grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));
// `
// const ItemsListTwoColumns = styled.ul`
//     grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));
// `
// const ItemListRows = styled.ul`
    ...
    render() {
        ...
        return(
            <div className="list-items-box__wrapper">
                <FiltersCharacters filtersProps={filtersProps}/>
...
const ItemsList = ({itemsList, onClickChar, loading, filterPosition}) => {
    ...
    } else if (filterPosition === 'rows') {
        styledClass="list-items-box__items list-items-box__items_rows"
    }
