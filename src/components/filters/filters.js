...
const Filters = ({ filtersProps: { total,
	...
	const filtersFilterPagesItemsRef = useRef();
	const filtersPagesItemRef = useRef();
	const filtersPagesHidddenBoxRef = useRef();
		...
		return arr.map(item => {
			...
			return (
				<li key={item} className={styledClass} onClick={() => {
					...
					filtersFilterPagesItemsRef.current.classList.toggle('filters__filter-pages_drop-down-list')
				}}>{item}</li>
			)
		});
	}
	...
	const clickFilterButton = () => {
		const wrapper = filtersPagesItemRef;
		const wrapperWidth = wrapper.offsetWidth;
		const wrapperHiddenWidth = filtersPagesHidddenBoxRef.current.offsetWidth;
		return {
	...
	return (
		<div className="filters">
			<div className="filters__pages">
				...
				<div ref={filtersPagesHidddenBoxRef} className="filters__pages__hidden-box">
			...
			<div className="filters__filter-pages">
				...
				<ul ref={filtersFilterPagesItemsRef} className="filters__filter-pages__items">
					{itemsFilterPages}
				</ul>
			</div>
			{filterPositionBox}
